...
export default class BoatDesign {
   ...
   */
  private static computeBoatData( samples = 1000 ): string {
...
`;
  ...
  private static readonly DESIGN_DISPLACED_VOLUME = 639528.5488299973;
  private static readonly DESIGN_HULL_VOLUME = 71060.28389217648;
  private static readonly ONE_LITER_HEIGHT = 0.05803411405138953;
  ...
  private static readonly DESIGN_BOUNDS = new Bounds3( -3.36, -50, -52.4, 202.4, 0, 52.4 );
