  ...
  private updateLiquid(): void {
    ...
    if ( boat ) {
      if ( boat.visibleProperty.value ) {
        ...
        else if ( boatLiquidVolume > 0 && boatLiquidVolume < basinMaximumVolume && boat.stepTop > this.pool.liquidYInterpolatedProperty.value ) {
          // If the boat got some water in it, drown it!
