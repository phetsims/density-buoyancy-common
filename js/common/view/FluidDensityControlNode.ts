 ...
 *
 * TODO AV: BUG: Changing the fluid density slider on Buoyancy/Explore does not change the actual fluid density (block doesn't move). See https://github.com/phetsims/density-buoyancy-common/issues/256
 *
