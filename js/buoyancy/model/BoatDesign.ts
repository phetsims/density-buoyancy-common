...
export default class BoatDesign {
  ...
  public static getIntersectionVertices( blockHalfWidth = 0, liters = 1 ): Vector2[] {
    ...
    // TODO: Don't require a reverse here https://github.com/phetsims/density-buoyancy-common/issues/86
  ...
  public static fillWaterVertexArray( waterY: number, boatX: number, boatY: number, liters: number, poolBounds: Bounds3, positionArray: Float32Array, wasFilled: boolean ): boolean {
    ...
    if ( isFilled ) {
      ...
      // TODO: reduce these allocations? https://github.com/phetsims/density-buoyancy-common/issues/86
  ...
  public static getPrimaryGeometry( liters = 1, includeExterior = true, includeGunwale = true, includeInterior = true, invertNormals = false ): THREE.BufferGeometry {
    ...
    const writeFlat = ( frontCurve: Vector3[], backCurve: Vector3[], normal: Vector3 ) => {
      ...
      for ( let i = 0; i < frontCurve.length - 1; i++ ) {
        ...
        const vL = 0;
        const vR = 1; // TODO: better mapping for the boat bottom presumably? https://github.com/phetsims/density-buoyancy-common/issues/86
    ...
    const writeGrid = ( rows: Vector3[][], normalRows: Vector3[][], reverse: boolean ) => _.range( 0, rows.length - 1 ).forEach( i => _.range( 0, rows[ i ].length - 1 ).forEach( j => {
      ...
      // TODO: better way to factor this out? https://github.com/phetsims/density-buoyancy-common/issues/86
      if ( reverse ) {
        positions.push(
          pA.x, pA.y, pA.z,
          pB.x, pB.y, pB.z,
    ...
    const interiorNormalRows = normalizeRows( interiorRows ); // TODO: we'll presumably need to reverse these https://github.com/phetsims/density-buoyancy-common/issues/86
...
`;
  ...
  public static readonly DESIGN_WALL_THICKNESS = 2.4;
  ...
  public static readonly ONE_LITER_SCALE_MULTIPLIER = 0.0011606822810277906;

  // The centroid of the hull of the boat, in design coordinates
  public static readonly DESIGN_CENTROID = new Vector3( 127.01221454497677, -30.985933407134237, 0 );
  public static readonly DESIGN_DISPLACED_VOLUME = 639528.5488299973;
  public static readonly DESIGN_HULL_VOLUME = 71060.28389217648;
  public static readonly ONE_LITER_HEIGHT = 0.05803411405138953;
  ...
  public static readonly DESIGN_BOUNDS = new Bounds3( -3.36, -50, -52.4, 202.4, 0, 52.4 );
