 ...
 * please modify density-buoyancy-common/package.json to control dependencies.
 *
 * RequireJS configuration file for the density-buoyancy-common sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'density-buoyancy-common-tests' ],
